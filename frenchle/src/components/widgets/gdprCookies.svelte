<script>
  ...
  export let description_1 =
          'We use cookies to offer a better browsing experience, analyze site traffic and provide statistics for Frenchle. By Continuing, you consent to our ';
  ...
  const choicesDefaults = {
    ...
    statistics: {
      ...
      description: 'Used for Statistics purposes. Such as keeping your Frenchle score',
      value: true
    },
    analytics: {
    ...
    <div class="cookieConsent">
      <div class="cookieConsent__Left">
        <div class="cookieConsent__Content">
          ...
          <a href="https://nasoj.me/foodle/privacy.html">Privacy Policy</a>
          <p class="cookieConsent__Description">
            {@html description_2}
          </p>
        </div>
