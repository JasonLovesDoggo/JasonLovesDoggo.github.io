...
\resumeSubheading{Founding Software Engineer}{Jul. 2024 - Present}{\textit{\href{https://storagebox.app/}{StorageBox}}}{Toronto, ON}

\resumeItemListStart
\resumeItem{Developed \textbf{12} core RESTful APIs with Django REST Framework and Channels for \textbf{real-time} inventory management, order processing, and secure and atomic transactions between Shopify stores, storage providers, and end-users}
\resumeItem{Enhanced platform responsiveness by \textbf{1,360\%} by implementing background task processing with Celery and Valkey}
\resumeItemListEnd
...
\resumeSubheading
{Research Assistant}{Jun. 2024 - Aug. 2024}
