...
\resumeSubheading{Software Engineer}{Sep. 2024 - Present}{\textit{\href{https://storagebox.app/}{StorageBox}}}{Toronto, ON}

\resumeItemListStart
\resumeItem{Developed \textbf{12 core RESTful APIs} with Django REST Framework and Channels for \textbf{real-time inventory management}, \textbf{order processing}, and \textbf{secure transactions} between Shopify stores, storage providers, and end-users}
...
\resumeItem{Designed and implemented polymorphic comments, likes, view counts, and saves, adding user-interaction to the site}
\resumeItemListEnd
...
\resumeItem{Research Assistant to Dr. Alvine Boaye Belle \textbf{|} Analyzed AI/ML fairness, reducing model bias $\sim$\textbf{15\%}. Researched and proposed solutions to access barriers in tech, boosting underrepresented participation in program by \textbf{13\%}}
