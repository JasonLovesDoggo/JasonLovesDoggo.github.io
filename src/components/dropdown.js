    ...
    return (
        <Dropdown title="Other sites/smaller projects" as={NavItem}>
            ...
            <Dropdown.Menu className="dropdown-container" onMouseEnter={() => setShow(true)}
                ...
                <Dropdown.Item title="A wordle clone that I made that has received 5m+ page views"
                               className="dropdown-item" href="/foodle"><IoGameController
                    style={{marginBottom: "2px"}}/> Foodle</Dropdown.Item>
                <Dropdown.Divider/>
                <Dropdown.Item title="A simple random color generator I made to learn some JS" className="dropdown-item"
                               href="/random-color"><IoColorPalette style={{marginBottom: "2px"}}/> Random
                    Color</Dropdown.Item>
                <Dropdown.Divider/>
