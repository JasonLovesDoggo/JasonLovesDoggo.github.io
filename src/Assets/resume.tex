...
\resumeItem{Reduced infrastructure costs by \textbf{35\%} and increased speeds by \textbf{22\%} utilizing \underline{\href{https://redis.io/docs/latest/develop/use/pipelining/}{pipelining}} and optimizing Docker networks}
\resumeItemListEnd
